...
- [Օպերատորի աշխատանքային ստանդարտները](#օպերատորի-աշխատանքային-ստանդարտները)
  - [Հաճախորդի հետ շփում](#հաճախորդի-հետ-շփում)
    - [Կանոններ](#կանոններ)
    - [SMS հաստատման տեքստ](#sms-հաստատման-տեքստ)
  - [Հաշվարկներ](#հաշվարկներ)
    - [Գնում](#գնում)
    - [Կանխիկացում](#կանխիկացում)
  - [Գումարի ստացում և կանխիկացում](#գումարի-ստացում-և-կանխիկացում)
    - [Idram](#idram)
    - [TelCell](#telcell)
    - [Easy Wallet](#easy-wallet)
    - [Inecofriend](#inecofriend)
    - [Քարտի վրա գումարի ստացում](#քարտի-վրա-գումարի-ստացում)
    - [Քարտի վրա կանխիկացում](#քարտի-վրա-կանխիկացում)
    - [QIWI](#qiwi)
  - [Binance և ալտքոիններ](#binance-և-ալտքոիններ)
    - [Վաճառքի ուղեցույց` օրինակի վրա](#վաճառքի-ուղեցույց-օրինակի-վրա)
    - [Կանխիկացման ուղեցույց` օրինակի վրա](#կանխիկացման-ուղեցույց-օրինակի-վրա)
  - [Դրամապանակների հետ կապված զանգեր](#դրամապանակների-հետ-կապված-զանգեր)
  - [Տուգանքներ](#տուգանքներ)
  - [Դրամապանակների կոդերը](#դրամապանակների-կոդերը)
  - [Տեղեկություն բանկերի մանսին](#տեղեկություն-բանկերի-մանսին)
...
3. Երբ գրում են անձնական պրոֆիլին, ուղղորդել օպերատորի պրոֆիլին
4. Չզլանալ հաճախորդին նույն բանը մի քանի անգամ բացատրելուց\` նույնչափ հարգալից կերպով
5. Հաճախորդները հաճախ ընտրում են չենջերը ըստ նրա, թե ում հետ է ավելի հաճելի երկու բառ փոխանակել ու ով է ավելի արագ սպասարկում։ Այդ պատճառով պետք է աշխատել մաքսիմալ քիչ սպասացնել մարդկանց ու հաճախորդի համար խոսակցության հաճելի մթնոլորտ ստեղծել։
6. Մշտական հաճախորդի հետ խոսելիս, եթե չենք հիշում ով է, ինչ տեսակի գործարքներ է անում, թերթել նախորդ խոսակցությունները, հասկանալ գնորդ է, թե կանխիկացնող, որպեսզի անմիջապես հասկանանք, թե ինչ է ուզում, ավելորդ հարցեր չտանք, կանխիկացնողին գնելու հաշիվ չտանք և այլն։
...
4. Ամեն գործարքին ավելանում է փոխանցման վճար, որը ծածկում է փոխանցում անելու ծախսը, ինչպես նաև տերմինալից փոխանցման հնարավոր կորուստը։ Բիթքոինի սովորական հասցեի դեպքում փոխանցման վճարը 1000-2000դր է։ Երբեմն ավել կամ պակաս է լինում և հաշվիչը ավտոմատ գրում է այդ պահի թիվը։ Դաշի, մեյլի ու բիթքոինի քոինբեյզ հասցեով փոխանցման վճարը միշտ +100 է։
...
5. Եթե ոչ մի իդրամի բալանսի վրա գումարը չի հերիքում, անգամ գումարային մաս-մաս փոխանցելու համար, փոխանցում անելիս գումարի աղբյուր ենք ընտրում rocket կամ gold քարտը։ Եթե էդտեղ էլ չկա, ձեն ենք տալիս Էդոյին կամ Միքոյին։
6. [Իդրամ տերմինալների քարտեզը](https://www.google.com/maps/d/u/0/embed?mid=1OvRBfZLLNnfaCLZKJW3TvSh5cjQ&ll=40.10946864888171%2C44.83641166937719&z=7)
7. Եթե պետք է իմանալ, թե ինչ բանկի քարտ է, կարող ենք իդրամում, «փոխանցում քարտին» բաժնում մուտք անել քարտի թվերը ու տեսնել բանկը։
8. Իդրամը ունի շուրջօրյա տեխնիկական սպասարկում
...
4. Telcell-ի տեխնիկական սպասարկումը աշխատում է երկուշաբթի-ուրբաթ ժամը 09:00-02:00, ոչ աշխատանքային (հանգստյան և տոնական) օրերին\` ժամը 09:00-22:00:
...
#### Կանխիկացման ուղեցույց` օրինակի վրա
